...
- [x] Modifying serialized objects (Apprentice)| [Youtube Video](https://youtu.be/ANsoMvOeLb4)
...
- [x] Excessive trust in client-side controls (Apprentice) | [Youtube Video](https://youtu.be/NxBGF347zm4)
- [ ] High-level logic vulnerability (Apprentice) | [Youtube Video]()
- [ ] Inconsistent security controls (Apprentice) | [Youtube Video]()
- [ ] Flawed enforcement of business rules (Apprentice) | [Youtube Video]()
- [ ] Low-level logic flaw (Practitioner) | [Youtube Video]()
- [ ] Inconsistent handling of exceptional input (Practitioner) | [Youtube Video]()
- [ ] Weak isolation on dual-use endpoint (Practitioner) | [Youtube Video]()
- [ ] Insufficient workflow validation (Practitioner) | [Youtube Video]()
- [ ] Authentication bypass via flawed state machine (Practitioner) | [Youtube Video]()
- [ ] Infinite money logic flaw (Practitioner) | [Youtube Video]()
- [ ] Authentication bypass via encryption oracle (Practitioner) | [Youtube Video]()
- [ ] Bypassing access controls using email address parsing discrepancies (Expert) | [Youtube Video]()
